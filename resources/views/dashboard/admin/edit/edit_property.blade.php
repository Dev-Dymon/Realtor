        ...
        <section class="section">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 text-right">
                    <a class="text-black" href="{{ route('admin.properties') }}">back</a>
                </div>
            </div>
                                    ...
                                    <div class="row g-3 mb-1">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control" name="name" required
                                                value="{{ $property->name ?? old('name') }}" placeholder="Property name">
                                            @error('name')
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control" name="location" required
                                                value="{{ $property->location ?? old('location') }}" placeholder="Property location">
                                            @error('location')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-3 mb-1">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12">
                                            ...
                                            <input class="form-control" type="number" name="no_of_bedroom" required
                                                value="{{ $property->no_of_bedroom ?? old('no_of_bedroom') }}" placeholder="no of bedroom">
                                            @error('no_of_bedroom')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12">
                                            ...
                                            <input class="form-control" type="number" name="no_of_toilet" required
                                                value="{{ $property->no_of_toilet ?? old('no_of_toilet') }}" placeholder="no of toilet">
                                            @error('no_of_toilet')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-3 mb-1">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12">
                                            ...
                                            <input class="form-control" type="number" name="price" required
                                                value="{{ $property->price ?? old('price') }}" placeholder="property price">
                                            @error('price')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-3 mb-1">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-12">
                                            ...
                                            <input type="text" class="form-control" name="size" required
                                                value="{{ $property->size ?? old('size') }}" placeholder="200 SQM">
                                            @error('size')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea class="form-control" id="description" rows="5" style="resize: vertical !important;" required
                                                name="description" placeholder="property description">{{ $property->description ?? old('description') }}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_1 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_1) }}" alt=""
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_2 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_2) }}" alt=""
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_3 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_3) }}" alt=""
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_4 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_4) }}" alt=""
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_5 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_5) }}" alt=""
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_6 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_6) }}" alt=""
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_7 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_7) }}" alt=""
                                        ...
                                        <div class="col-lg-3 col-md-3 col-6 upload-img-div">
                                            @if ($property->image_8 !== null)
                                               <img src="{{ asset('uploads/properties/'. $property->image_8) }}" alt=""
