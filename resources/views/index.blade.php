		...
		<div class="container">
			<div class="row mb-5 align-items-center">
				...
				<div class="col-lg-6 text-lg-end">
					<p>
						<a href="{{ route('all_property') }}" target="_blank" class="btn btn-primary text-white py-3 px-4">View all properties</a>
					</p>
				</div>
			</div>
			<div class="row">
	...
	<div class="section section-5 bg-light">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="h-100 person">
						<img src="{{ asset('assets/images/person_3-min.jpg') }}" alt="Image" class="img-fluid" />
